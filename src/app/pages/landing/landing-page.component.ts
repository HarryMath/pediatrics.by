  ...
  services: IService[] = [
    ...
    },
    {
      ...
      includes: [
        ...
        ' Паспорт (любой возраст) - 55 руб',
        ' План + паспорт (до года) - 65 руб',
        ' План + паспорт (старше года) - 75 руб',
        ' План (старше года) - 55 руб',
        'Подробности  <a class="link" href="https://www.instagram.com/stories/highlights/18008094178951834/">смотрите здесь</a>',
      ],
      action: {
        txt: 'Заказать',
        action: () => {
    ...
    },
    {
      ...
      includes: [
        ...
        'Для участия в семинаре "Железо" заполните форму по <a class="link" href="https://timekit.by/form/16">ссылке</a>',
        // 'На данный момент семинар "ПРИКОРМ" не проводится. Обычно мы проводим семинары раз в 2-3 месяца',
        'Сейчас идет набор на поток "ПРИКОРМ 8.0". Подробнее узнать можно у нас в <a class="link" href="https://www.instagram.com/stories/highlights/18003047930528500/">актуальном</a>. А для участия нажмите на кнопку ниже'
      ],
      action: {
        txt: 'Участвовать',
        action: () => {
