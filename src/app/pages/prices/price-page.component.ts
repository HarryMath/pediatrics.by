  ...
  private readonly priceListNew = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Повторный прием врача-педиатра', price: 45 },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Личный педиатр (возраст от 1 года, врач-педиатр)', price: 1200 },
        { name: 'У меня вопрос (возраст от 1 года, врач-педиатр, директор клиники)', price: 600 },
        { name: 'У меня вопрос (возраст от 1 года, врач-педиатр)', price: 540 },
        { name: 'Рука на пульсе', price: 420 },
      ],
    }
  ];
